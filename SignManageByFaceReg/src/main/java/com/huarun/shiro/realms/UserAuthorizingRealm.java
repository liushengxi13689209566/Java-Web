...
public class UserAuthorizingRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authenticationToken) throws AuthenticationException {
        ...
        try {
            ...
            if (!StringUtils.isNumeric(user_name))
                throw new AuthenticationException();
            Integer userID = Integer.valueOf(user_name);
            //依赖于/security.service.Interface.UserInfoService,userInfo 中包含用户ID,用户名，密码，角色
            //wms_user表
            ...
            //realmName为com.huarun.security.realms.UserAuthorizingRealm_0
...
//            //依赖于/security.service.Interface.UserInfoService,userInfo中包含用户ID,用户名，密码，角色
//            //wms_user表
//            userInfo userInfo = userInfoService.getUserInfo(userID);
//
//            if (userInfo != null) {
